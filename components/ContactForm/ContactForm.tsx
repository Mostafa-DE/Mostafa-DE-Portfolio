...
import {EMAIL_API_URL} from "@/config/index";
...
export default function ContactForm(): JSX.Element {
    ...
    const handleSubmit = async (evnt: React.SyntheticEvent) => {
        evnt.preventDefault();
        setIsLoading(true);
        const URL = `${EMAIL_API_URL}?name=${values.name}&email=${values.email}&message=${values.message}`;
    ...
    return (
        <ContactFormContainer id="contact">
            <div className="container">
                ...
                <p className="whoIam">
                    __ Got a question or want to work together? Feel free to reach out—I’d love to hear from you! __
                </p>
            </div>
            <Box>
                {openSuccessAlert && (
                        ...
                        <Box>
                            ...
                            <Box display="flex" justifyContent="center">
                                <Button
                                    ...
                                    className="SubmitBtn"
                                >
                                    {isLoading ? <ImSpinner9 className="spinner"/> : "Submit"}
                                </Button>
                            </Box>
                        </Box>
                    </ValidatorForm>
