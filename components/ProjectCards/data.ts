...
export const projectCardData: IProjectCardData[] = [
    {
        ...
        description: `
            This is a full-stack e-commerce platform built with Next.js, Material UI, and strapi as CMS.
    ...
    },
    {
        ...
        description: `
            This is a color picker built with React.js and Material UI.
    ...
    },
    {
        ...
        subtitle: "A simple demo app authentication using Django(drf and knox) and React(Vite).",
        description: `
